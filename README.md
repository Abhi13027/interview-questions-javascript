...
## 4Q. **_What are the data types in Node.js?_**
...
## 5Q. **_How to create a simple server in Node.js that returns Hello World?_**
...
## 7Q. **_What is an error-first callback?_**
...
## 8Q. **_What is callback hell in Node.js?_**
...
## 9Q. **_What are Promises in Node.js?_**
...
## 10Q. **_What tools can be used to assure consistent style?_**
...
## 11Q. **_When should you npm and when yarn?_**
...
## 13Q. **_What is a test pyramid? How can you implement it when talking about HTTP APIs?_**
...
## 14Q. **_How can you secure your HTTP cookies against XSS attacks?_**
...
## 15Q. **_How can you make sure your dependencies are safe?_**
...
## 16Q. **_What is Event loop in Node.js? And How does it work?_**
...
## 17Q. **_What is REPL? What purpose it is used for?_**
...
## 18Q. **_What is the difference between Asynchronous and Non-blocking?_**
...
## 19Q. **_How to debug an application in Node.js?_**
...
## 20Q. **_What are some of the most popular modules of Node.js?_**
...
## 21Q. **_What is EventEmitter in Node.js?_**
...
## 22Q. **_How many types of streams are present in node.js?_**
...
## 23Q. **_What is crypto in Node.js? How do you cipher the secure information in Node.js?_**
...
## 24Q. **_What is the use of DNS module in Node.js?_**
...
## 25Q. **_What are the security mechanisms available in Node.js?_**
...
## 26Q. **_Name the types of API functions in Node.js?_**
...
## 27Q. **_How does Node.js handle child threads?_**
...
## 28Q. **_What is the preferred method of resolving unhandled exceptions in Node.js?_**
...
## 29Q. **_How does Node.js support multi-processor platforms, and does it fully utilize all processor resources?_**
...
## 30Q. **_What is typically the first argument passed to a Node.js callback handler?_**
...
## 31Q. **_How Node.js read the content of a file?_**
...
## 32Q. **_What is JIT and how is it related to Node.js?_**
...
## 33Q. **_What is difference between put and patch?_**
...
## 34Q. **_List types of Http requests supported by Node.js?_**
...
## 36Q. **_Write the steps for setting up an Express JS application?_**
...
## 37Q. **_Since node is a single threaded process, how to make use of all CPUs?_**
...
## 38Q. **_What does emitter do and what is dispatcher?_**
...
## 39Q. **_How to kill child processes that spawn their own child processes in Node.js?_**
...
## 40Q. **_What do you understand by Reactor Pattern in Node.js?_**
...
## 41Q. **_What are the key features of Node.js?_**
...
## 42Q. **_What are globals in Node.js?_**
...
## 43Q. **_What is chaining process in Node.js?_**
...
## 44Q. **_What is a control flow function? what are the steps does it execute?_**
...
## 46Q. **_When to use Node.js and when not to use it?_**
...
## 47Q. **_Explain how does Node.js work?_**
...
## 48Q. **_Is Node.js entirely based on a single-thread?_**
...
## 49Q. **_How to make post request in Node.js?_**
...
## 50Q. **_Can you create http server in Node.js, explain the code used for it?_**
...
## 51Q. **_How to load html in Node.js?_**
...
## 52Q. **_How can you listen on port 80 with Node?_**
...
## 53Q. **_What is the difference between operational and programmer errors?_**
...
## 54Q. **_Why npm shrinkwrap is useful?_**
...
## 55Q. **_What is your favourite HTTP framework and why?_**
...
## 56Q. **_What are the Challenges with Node.js?_**
...
## 57Q. **_What is the difference between Node.js vs Ajax?_**
...
## 58Q. **_How Node.js overcomes the problem of blocking of I/O operations?_**
...
## 59Q. **_Mention the steps by which you can async in Node.js?_**
...
## 60Q. **_What are the timing features of Node.js?_**
...
## 61Q. **_What is LTS releases of Node.js why should you care?_**
...
## 62Q. **_Why should you separate Express 'app' and 'server'?_**
...
## 63Q. **_What is the difference between process.nextTick() and setImmediate()?_**
...
## 64Q. **_What is difference between JavaScript and Node.js?_**
...
## 65Q. **_What are the difference between Events and Callbacks?_**
...
## 66Q. **_Explain RESTful Web Services in Node.js?_**
...
## 67Q. **_How to handle file upload in Node.js?_**
...
## 68Q. **_Explain the terms body-parser, cookie-parser, morgan, nodemon, pm2, serve-favicon, cors, dotenv, fs-extra, moment in Express JS?_**
...
## 69Q. **_How does routing work in Node.js?_**
...
## 70Q. **_How node.js prevents blocking code?_**
...
## 71Q. **_What is difference between promises and async-await in Node.js?_**
...
#### 72Q. **_How to use JSON Web Token (JWT) for authentication in Node.js?_**
...
## 73Q. **_How to build a microservices architecture with Node.js?_**
...
## 74Q. **_How to use Q promise in Node.js?_**
...
## 75Q. **_How to implement Memcached in Node.js?_**
...
## 76Q. **_How to generate and verify checksum of the given string in Node.js_**
...
#### 77Q. **_Explain error handling in Node.js?_**

#### 78Q. **_How to use locale (i18n) in Node.js?_**
